        ...
        public IActionResult Cadastro(CategoriasCadastroViewModel model)
        {
            if(ModelState.IsValid)
            {
                try 
                {
                    ...
                    TempData["MensagemSucesso"] = $"Categoria {categoria.Nome}, cadastrada com suceso.";
            ...
            try 
            {
                ...
                if(categoria != null && categoria.IdUsuario == UsuarioAutenticado.Id)
                {
                   ...
                   if(qtdContas == 0) 
                    ...
                    {
                        TempData["MensagemAlerta"] = $"Não é possivel excluir, pois existem {qtdContas} contas(s) cadastrada(s) para esta categoria.";
