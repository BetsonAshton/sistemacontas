    ...
    public class ContasController : Controller
    {
        ...
        public IActionResult Cadastro(ContasCadastroViewModel model)
        {
            if(ModelState.IsValid)
            {
                try 
                {
                    ...
                    conta.Tipo = model.Tipo == 1 ? TipoConta.Receber : Data.Enums.TipoConta.Pagar; //If ternário
        ...
        public IActionResult Consulta() 
        {
            ...
            try 
            {
                ...
                model.DataIni = dataIni.ToString("yyy-MM-dd");
                model.DataFim = dataFim.ToString("yyy-MM-dd");
        ...
        public IActionResult Edicao(Guid id)
        {
            ...
            try
            {
                ...
                //verficar se a conta foi encontrada e se pertence ao usuário autenticado
                if(conta != null && conta.IdUsuario ==UsuarioAutenticado.Id)
                {
                    model.Id = conta.Id;
                    model.Nome = conta.Nome;
                    model.Valor = conta.Valor;
                    model.Data = conta.Data.ToString("yyy-MM-dd");
        ...
        public IActionResult RelatorioExcel()
        {
            try 
            {
                ...
                return File(relatorio, "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet", "realtorio_categorias.xlsx");
        ...
        public IActionResult RelatorioPdf()
        {
            try
            {
                ...
                return File(relatorio, "application/pdf", "realtorio_categorias.pdf");
        ...
        private void ObterContas(ContasConsultaViewModel model)
        {
            ...
            foreach (var item in contas)
            {
                ...
                resultado.Data = item.Data.ToString("ddd/MM/yyyy");
